...
function main() {
    _butomEl.initButtonEl();
    //initPtesentationTitle()
    _handPapel.initHandPapel();
    _handPiedra.initHandPiedra();
    //  initHandTijera()
    //initPtesentationTitle()
...
},{"./router":"b2iia","./components/hand-papel":"gsfQe","./components/butomEl":"84jut","./components/hand-piedra":"jSNGQ"}],"b2iia":[function(require,module,exports) {
...
//const BASE_PATH = "/desafio-dwf-5-1"
const routes = [
    {
        path: /\/wellcome/,
        component: _wellcome.wellcome
    }
];
...
},{"./pages/wellcome":"042nT","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"042nT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "wellcome", ()=>wellcome
);
function wellcome(direction) {
    const div = document.createElement("div");
    div.innerHTML = `\n    <custom-presentation></custom-presentation>\n    <custom-button class="buttonEl" title="Empezar"></custom-button>\n    <div class="hands">\n        <hand-piedra></hand-piedra>\n        <hand-papel></hand-papel>\n        <hand-tijera></hand-tijera>\n    </div>\n    `;
    div.classList.add("contenedor");
    const style = document.createElement("style");
    style.textContent = `\n    .hands{\n        display:flex;\n        width: 80%;\n        justify-content: space-evenly;\n        position: relative;\n        top: 10px;\n    }\n    .contenedor{\n        display: flex;\n        flex-direction: column;\n        justify-content: space-between;\n        align-items: center;\n        height: 100vh;\n        padding: 85px 0 0 0;\n    }\n    `;
    function butomAction() {
        const butonEl = div.querySelector(".buttonEl");
        butonEl?.addEventListener("click", (e)=>{
            direction.goTo("/reglas");
        });
    }
    butomAction();
...
},{}],"gsfQe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","/src/images/papel.svg":"hhVgc"}],"hhVgc":[function() {},{}],"84jut":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initButtonEl() {
    class buttonComponent extends HTMLElement {
        ...
        render() {
            ...
            div.innerHTML = `\n                <buttonEl clas="buttonEl">${this.title}</buttonEl>\n            `;
        }
    }
    customElements.define("custom-button", buttonComponent);
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"jSNGQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"/src/images/papel.svg":"hhVgc","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"hhVgc":[function() {},{}]},["8uBhv","4aleK"], "4aleK", "parcelRequire1b67")
